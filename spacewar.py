#!/usr/bin/env python
"""
Spacewar, created by Joel Martin (based on Solarwolf by Pete Shinners)
"""
...
def checkdependencies():
    ...
    if not os.path.isdir(CODEDIR):
        msgs.append('Cannot locate spacewar modules')
    if not os.path.isdir('data'):
        msgs.append('Cannot locate spacewar data files')
