...
the Spacewar ship must contact the cube multiple times
...
This powerup enables a temporary shield on your Spacewar
...
This powerup adds another Spacewar ship to your fleet.
-
